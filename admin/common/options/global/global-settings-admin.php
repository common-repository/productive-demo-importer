...
if( ! function_exists( 'productive_global_plugin_options_render_page_menu_global' ) ) {
    ...
    define( 'PRODUCTIVE_GLOBAL_SETTINGS_COMPONENT_NAME', __( 'Productive Global Settings', 'productive-demo-importer' ) );
    define( 'PRODUCTIVE_GLOBAL_SETTINGS_BROWSER_NAVBAR_TITLE', __( 'Productive Global Settings', 'productive-demo-importer' ) );
    define( 'PRODUCTIVE_GLOBAL_SETTINGS_BROWSER_SIDEBAR_MENU_TITLE', __( 'Global Settings', 'productive-demo-importer' ) );
    define( 'PRODUCTIVE_GLOBAL_ADMIN_PAGE_REQUEST_URI', 'productive_global_options_submenu' );
    define( 'PRODUCTIVE_GLOBAL_SETTINGS_SECTION_TITLE_GRID', __( 'Grids and Breakpoints', 'productive-demo-importer' ) );
    define( 'PRODUCTIVE_GLOBAL_SETTINGS_SECTION_TITLE_POPUP', __( 'PopUps', 'productive-demo-importer' ) );
    define( 'PRODUCTIVE_GLOBAL_SETTINGS_SECTION_TITLE_SLIDER', __( 'Sliders', 'productive-demo-importer' ) );
    define( 'PRODUCTIVE_GLOBAL_SETTINGS_SECTION_TITLE_SHARING', __( 'Sharing', 'productive-demo-importer' ) );
    define( 'PRODUCTIVE_GLOBAL_SETTINGS_SECTION_TITLE_MISC', __( 'Other Settings', 'productive-demo-importer' ) );
    ...
    define( 'PRODUCTIVE_GLOBAL_PRODUCTIVE_PLUGIN_MINDS_TITLE', __( 'Productive Minds', 'productive-demo-importer' ) );
    ...
    define( 'PRODUCTIVE_GLOBAL_PRODUCTIVE_PLUGIN_PRODUCT_TITLE', __( 'Productive Product', 'productive-demo-importer' ) );
    ...
    define( 'PRODUCTIVE_GLOBAL_PRODUCTIVE_PLUGIN_COMMERCE_TITLE', __( 'Productive Commerce', 'productive-demo-importer' ) );
    ...
    define( 'PRODUCTIVE_GLOBAL_PRODUCTIVE_PLUGIN_FORMS_TITLE', __( 'Productive Forms', 'productive-demo-importer' ) );
    ...
    define( 'PRODUCTIVE_GLOBAL_PRODUCTIVE_PLUGIN_STYLE_TITLE', __( 'Productive Style', 'productive-demo-importer' ) );
    ...
    define( 'PRODUCTIVE_GLOBAL_PRODUCTIVE_PLUGIN_DEMO_IMPORTER_TITLE', __( 'Productive Demo Importer', 'productive-demo-importer' ) );
    ...
    function productive_global_register_pattern_categories() {
        register_block_pattern_category( 'productive_global/productive_minds', array( 
            'label'       => __( 'ProductiveMinds', 'productive-demo-importer' ),
            'description' => __( 'ProductiveMinds Patterns.', 'productive-demo-importer' )
        ) );
    }
    ...
    ?>
        ...
        <h2 class="wp-block-heading h3"><?php echo __( 'Productive Commerce, A Required Plugin for This Pattern, Is Missing', 'productive-demo-importer' ); ?></h2>
        <!-- /wp:heading -->
        <!-- wp:paragraph -->
        <p><?php echo __( 'To access this pattern, first activate the Productive Commerce plugin: ', 'productive-demo-importer' ); ?> <a href="https://wordpress.org/plugins/productive-commerce" data-type="link" data-id="https://wordpress.org/plugins/productive-commerce">https://wordpress.org/plugins/productive-commerce</a></p>
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
        <p><span class="bolded"><?php echo __( 'Pattern: ', 'productive-demo-importer' ); ?></span> <?php echo esc_html( $pattern_name ); ?></p>
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
        <?php if( !empty($pattern_demo_url) ) { ?>
        <p><span class="bolded"><?php echo __( 'Pattern Demo: ', 'productive-demo-importer' ); ?></span><a href="<?php echo esc_url( $pattern_demo_url ); ?>" data-type="link" data-id="<?php echo esc_url( $pattern_demo_url ); ?>"><?php echo esc_url( $pattern_demo_url ); ?></a></p>
        <?php } ?>
        <!-- /wp:paragraph -->
    <?php 
    }
    ...
    ?>
        <!-- wp:heading {"className":"wp-block-heading"} -->
        <h2 class="wp-block-heading h3"><?php echo __( 'Productive Forms, A Required Plugin for This Pattern, Is Missing', 'productive-demo-importer' ); ?></h2>
        <!-- /wp:heading -->
        <!-- wp:paragraph -->
        <p><?php echo __( 'To access this pattern, first activate the Productive Forms plugin: ', 'productive-demo-importer' ); ?> <a href="https://wordpress.org/plugins/productive-forms" data-type="link" data-id="https://wordpress.org/plugins/productive-forms">https://wordpress.org/plugins/productive-forms</a></p>
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
        <p><span class="bolded"><?php echo __( 'Pattern: ', 'productive-demo-importer' ); ?></span> <?php echo esc_html( $pattern_name ); ?></p>
        <!-- /wp:paragraph -->
    ...
    ?>
        <!-- wp:heading {"className":"wp-block-heading"} -->
        <h2 class="wp-block-heading h3"><?php echo __( 'Productive Style, A Required Plugin for This Pattern, Is Missing', 'productive-demo-importer' ); ?></h2>
        <!-- /wp:heading -->
        <!-- wp:paragraph -->
        <p><?php echo __( 'To access this pattern, first activate the Productive Style plugin: ', 'productive-demo-importer' ); ?> <a href="https://wordpress.org/plugins/productive-style" data-type="link" data-id="https://wordpress.org/plugins/productive-style">https://wordpress.org/plugins/productive-style</a></p>
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
        <p><span class="bolded"><?php echo __( 'Pattern: ', 'productive-demo-importer' ); ?></span> <?php echo esc_html( $pattern_name ); ?></p>
        <!-- /wp:paragraph -->
    ...
    function productive_global_options_render_page_menu_html() {
        ...
        if ( !current_user_can( 'manage_options' ) ) {
            add_settings_error( 'productive_global_admin_messages', 'productive_global_admin_message', esc_html__( 'You do not have permission to access this resource.', 'productive-demo-importer' ), 'error' );
        ...
        if ( isset( $_GET['settings-updated'] ) && $is_error_count_section_grid < 1 && $is_error_count_section_popup < 1 && $is_error_count_section_slider < 1 && $is_error_count_section_sharing < 1 && $is_error_count_section_misc < 1 ) {
            ...
            add_settings_error( 'productive_global_admin_messages', 'productive_global_admin_message', __( 'Settings Saved', 'productive-demo-importer' ), 'updated' );
        }
        settings_errors( 'productive_global_admin_messages' );
    ...
    function productive_global_get_activate_or_deactivate_options() {
        return array (
            '1' => __( 'Activate', 'productive-demo-importer' ),
            '0' => __( 'De-Activate', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_enable_or_disable_options() {
        return array (
            '1' => __( 'Enable', 'productive-demo-importer' ),
            '0' => __( 'Disable', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_show_or_hide_options() {
        return array (
            '1' => __( 'Show', 'productive-demo-importer' ),
            '0' => __( 'Hide', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_yes_or_no_options() {
        return array (
            '1' => __( 'Yes', 'productive-demo-importer' ),
            '0' => __( 'No', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_true_or_false_options() {
        return array (
            '1' => __( 'True', 'productive-demo-importer' ),
            '0' => __( 'False', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_start_or_stop_options() {
        return array (
            '1' => __( 'Start', 'productive-demo-importer' ),
            '0' => __( 'Stop', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_show_item_on_the_left_or_right_or_hide_options() {
        return array (
            'hide' => __( 'Hide', 'productive-demo-importer' ),
            'position_left' => __( 'Left', 'productive-demo-importer' ),
            'position_right' => __( 'Right', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_display_post_media_options() {
        return array (
            'none' => __( 'None', 'productive-demo-importer' ),
            'image' => __( 'Image', 'productive-demo-importer' ),
            'icon' => __( 'Icon', 'productive-demo-importer' ),
        );
    }
    ...
    function productive_global_get_display_post_title_options() {
        return array (
            '0' => __( 'Hide', 'productive-demo-importer' ),
            '1' => __( 'Text', 'productive-demo-importer' ),
            '2' => __( 'Link, Open In The Same Window', 'productive-demo-importer' ),
            '3' => __( 'Link, Open In New Window', 'productive-demo-importer' ),
        );
    }
    ...
    function productive_global_get_display_as_link_options_with_hide() {
        return array (
            '0' => __( 'Hide', 'productive-demo-importer' ),
            '1' => __( 'Yes, Open In The Same Window', 'productive-demo-importer' ),
            '2' => __( 'Yes, Open In New Window', 'productive-demo-importer' ),
        );
    }
    ...
    function productive_global_get_basic_alignment_css_class_options() {
        return array (
            'justify-block-content-center'          => __( 'Center', 'productive-demo-importer' ),
            'justify-block-content-left'            => __( 'Left', 'productive-demo-importer' ),
            'justify-block-content-right'           => __( 'Right', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_basic_content_box_designs_options() {
        return array (
            'shapeable-content-box-default'                             => __( 'Default', 'productive-demo-importer' ),
            'shapeable-content-box-default-with-bg'                     => __( 'Default, with Background', 'productive-demo-importer' ),
            'shapeable-content-box-default-with-border'                 => __( 'Default, with Border', 'productive-demo-importer' ),
            'shapeable-content-box-rounded-corner-with-bg'              => __( 'Rounded Corner, with Background', 'productive-demo-importer' ),
            'shapeable-content-box-rounded-corner-with-border'          => __( 'Rounded Corner, with Border', 'productive-demo-importer' ),
            'shapeable-content-box-ellipsed-with-bg'                    => __( 'Ellipse, with Background', 'productive-demo-importer' ),
            'shapeable-content-box-ellipsed-with-border'                => __( 'Ellipse, with Border', 'productive-demo-importer' ),
            'shapeable-content-whole-box-default-with-bg'               => __( 'Default, with Background (Box)', 'productive-demo-importer' ),
            'shapeable-content-whole-box-default-with-border'           => __( 'Default, with Border (Box)', 'productive-demo-importer' ),
            'shapeable-content-whole-box-rounded-corner-with-bg'        => __( 'Rounded Corner, with Background (Box)', 'productive-demo-importer' ),
            'shapeable-content-whole-box-rounded-corner-with-border'    => __( 'Rounded Corner, with Border (Box)', 'productive-demo-importer' ),
            'shapeable-content-whole-box-ellipsed-with-bg'              => __( 'Ellipse, with Background (Box)', 'productive-demo-importer' ),
            'shapeable-content-whole-box-ellipsed-with-border'          => __( 'Ellipse, with Border (Box)', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_alignment_with_css_class_options() {
        return array (
            ''                  => __( 'Default', 'productive-demo-importer' ),
            'centered'          => __( 'Center', 'productive-demo-importer' ),
            'lefted'            => __( 'Start (Left)', 'productive-demo-importer' ),
            'righted'           => __( 'End (Right)', 'productive-demo-importer' ),
            'justified'         => __( 'Justify', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_vertical_css_align_options() {
        return array (
            'flex-start'        => __( 'Top', 'productive-demo-importer' ),
            'center'            => __( 'Middle', 'productive-demo-importer' ),
            'flex-end'          => __( 'Bottom', 'productive-demo-importer' ),
            'stretch'           => __( 'Stretch', 'productive-demo-importer' ),
            'space-evenly'      => __( 'Space Evenly', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_horizontal_css_align_options() {
        return array (
            'center'            => __( 'Center', 'productive-demo-importer' ),
            'flex-start'        => __( 'Start (Left)', 'productive-demo-importer' ),
            'flex-end'          => __( 'End (Right)', 'productive-demo-importer' ),
            'space-around'      => __( 'Space Around', 'productive-demo-importer' ),
            'space-evenly'      => __( 'Space Evenly', 'productive-demo-importer' ),
            'space-between'     => __( 'Space Between', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_vertical_align_items_options() {
        return array (
            'align-items-center'            => __( 'Middle', 'productive-demo-importer' ),
            'align-items-flex-start'        => __( 'Top', 'productive-demo-importer' ),
            'align-items-flex-end'          => __( 'Bottom', 'productive-demo-importer' ),
            'align-items-stretch'           => __( 'Stretch', 'productive-demo-importer' ),
            'align-items-baseline'          => __( 'Baseline', 'productive-demo-importer' ),
            'align-items-initial'           => __( 'Initial', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_vertical_align_content_options() {
        return array (
            'align-content-center'              => __( 'Middle', 'productive-demo-importer' ),
            'align-content-flex-start'          => __( 'Top', 'productive-demo-importer' ),
            'align-content-flex-end'            => __( 'Bottom', 'productive-demo-importer' ),
            'align-content-stretch'             => __( 'Stretch', 'productive-demo-importer' ),
            'align-content-space-between'       => __( 'Space Between', 'productive-demo-importer' ),
            'align-content-space-around'        => __( 'Space Around', 'productive-demo-importer' ),
            'align-content-space-evenly'        => __( 'Space Evenly', 'productive-demo-importer' ),
            'align-content-initial'             => __( 'Initial', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_horizontal_justify_items_options() {
        return array (
            'justify-items-center'          => __( 'Center', 'productive-demo-importer' ),
            'justify-items-start'           => __( 'Left (Start)', 'productive-demo-importer' ),
            'justify-items-end'             => __( 'Right (End)', 'productive-demo-importer' ),
            'justify-items-stretch'         => __( 'Stretch', 'productive-demo-importer' ),
            'justify-items-normal'          => __( 'Normal', 'productive-demo-importer' ),
            'justify-items-initial'         => __( 'Initial', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_horizontal_justify_content_options() {
        return array (
            'justify-content-center'                => __( 'Center', 'productive-demo-importer' ),
            'justify-content-flex-start'            => __( 'Left (Start)', 'productive-demo-importer' ),
            'justify-content-flex-end'              => __( 'Right (End)', 'productive-demo-importer' ),
            'justify-content-space-between'         => __( 'Space Between', 'productive-demo-importer' ),
            'justify-content-space-around'          => __( 'Space Around', 'productive-demo-importer' ),
            'justify-content-space-evenly'          => __( 'Space Evenly', 'productive-demo-importer' ),
            'justify-content-initial'               => __( 'Initial', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_colour_schemes_for_contents() {
        return array (
            'no_color_scheme'                   => __( 'None (no color scheme)', 'productive-demo-importer' ),
            'light_color_scheme'                => __( 'Light Color Scheme', 'productive-demo-importer' ),
            'dark_color_scheme'                 => __( 'Dark Color Scheme', 'productive-demo-importer' ),
            'themed_color_scheme'               => __( 'Theme&#39;s Color Scheme', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_colour_schemes_for_bg() {
        return array (
            'section_with_no_bg'                    => __( 'No (no color scheme)', 'productive-demo-importer' ),
            'section_with_light_bg'                 => __( 'Light Background', 'productive-demo-importer' ),
            'section_with_dark_bg'                  => __( 'Dark Background', 'productive-demo-importer' ),
            'section_with_light_bg_dark_content'    => __( 'Light Background, Dark Content', 'productive-demo-importer' ),
            'section_with_dark_bg_light_content'    => __( 'Dark Background, Light Content', 'productive-demo-importer' ),
            'section_with_themed_bg'                => __( 'Theme&#39;s Color Scheme', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_section_block_max_width() {
        return array (
            'siteMaxWidth_Std'                      => __( 'Default', 'productive-demo-importer' ),
            'siteMaxWidth_Narrow'                   => __( 'Narrow', 'productive-demo-importer' ),
            'siteMaxWidth_Narrow_Align_Left'        => __( 'Narrow, Align Left', 'productive-demo-importer' ),
            'siteMaxWidth_Narrow_Align_Right'       => __( 'Narrow, Align Right', 'productive-demo-importer' ),
            'siteMaxWidth_Thin'                     => __( 'Thin', 'productive-demo-importer' ),
            'siteMaxWidth_Thin_Align_Left'          => __( 'Thin, Align Left', 'productive-demo-importer' ),
            'siteMaxWidth_Thin_Align_Right'         => __( 'Thin, Align Right', 'productive-demo-importer' ),
            'siteMaxWidth_Mini'                     => __( 'Extra Thin', 'productive-demo-importer' ),
            'siteMaxWidth_Mini_Align_Left'          => __( 'Extra Thin, Align Left', 'productive-demo-importer' ),
            'siteMaxWidth_Mini_Align_Right'         => __( 'Extra Thin, Align Right', 'productive-demo-importer' ),
            'siteMaxWidth_Micro'                    => __( 'Micro Thin', 'productive-demo-importer' ),
            'siteMaxWidth_Micro_Align_Left'         => __( 'Micro Thin, Align Left', 'productive-demo-importer' ),
            'siteMaxWidth_Micro_Align_Right'        => __( 'Micro Thin, Align Right', 'productive-demo-importer' ),
            'siteMaxWidth_Wide'                     => __( 'Wide', 'productive-demo-importer' ),
            'siteMaxWidth_Extended'                 => __( 'Full Width (with padding)', 'productive-demo-importer' ),
            'siteMaxWidth_100pc'                    => __( 'Full Width (100%)', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_section_block_spacing_options() {
        return array (
            'section_spacing_none'                  => __( 'No Spacing', 'productive-demo-importer' ),
            'section_spacing_default'               => __( 'Default', 'productive-demo-importer' ),
            'section_spacing_small'                 => __( 'Small', 'productive-demo-importer' ),
            'section_spacing_large'                 => __( 'Large', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_section_page_align_width() {
        return array (
            'align_page_none'                   => __( 'Default', 'productive-demo-importer' ),
            'alignwide'                         => __( 'Wide Page Width', 'productive-demo-importer' ),
            'alignfull'                         => __( 'Full Page Width', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_shapeable_icon_shape_options() {
        return array (
            'shapeable-icon-default' => __( 'Default', 'productive-demo-importer' ),
            'shapeable-icon-sharped-corner' => __( 'Sharp Corner', 'productive-demo-importer' ),
            'shapeable-icon-rounded-corner' => __( 'Rounded Corner', 'productive-demo-importer' ),
            'shapeable-icon-ellipsed' => __( 'Ellipse', 'productive-demo-importer' ),
            'shapeable-icon-ovalled' => __( 'Oval', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_shapeable_image_shape_options() {
        return array (
            'shapeable-image-default' => __( 'Default', 'productive-demo-importer' ),
            'shapeable-image-sharped-corner' => __( 'Sharp Corner', 'productive-demo-importer' ),
            'shapeable-image-rounded-corner' => __( 'Rounded Corner', 'productive-demo-importer' ),
            'shapeable-image-ellipsed' => __( 'Ellipse', 'productive-demo-importer' ),
            'shapeable-image-ovalled' => __( 'Oval', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_grid_section_blocks_ratios( $include_full_width = false ) {
        $bloacks_ratio_array = array (
            'column_90_10' => __( '90 : 10', 'productive-demo-importer' ),
            'column_85_15' => __( '85 : 15', 'productive-demo-importer' ),
            'column_80_20' => __( '80 : 20', 'productive-demo-importer' ),
            'column_75_25' => __( '75 : 25', 'productive-demo-importer' ),
            'column_70_30' => __( '70 : 30', 'productive-demo-importer' ),
            'column_65_35' => __( '65 : 35', 'productive-demo-importer' ),
            'column_60_40' => __( '60 : 40', 'productive-demo-importer' ),
            'column_55_45' => __( '55 : 45', 'productive-demo-importer' ),
            'column_50_50' => __( '50 : 50', 'productive-demo-importer' ),
            'column_45_55' => __( '45 : 55', 'productive-demo-importer' ),
            'column_40_60' => __( '40 : 60', 'productive-demo-importer' ),
            'column_35_65' => __( '35 : 65', 'productive-demo-importer' ),
            'column_30_70' => __( '30 : 70', 'productive-demo-importer' ),
            'column_25_75' => __( '25 : 75', 'productive-demo-importer' ),
            'column_20_80' => __( '20 : 80', 'productive-demo-importer' ),
            'column_15_85' => __( '15 : 85', 'productive-demo-importer' ),
            'column_10_90' => __( '10 : 90', 'productive-demo-importer' ),
        );
        if( $include_full_width ) {
            $bloacks_ratio_array['column_100'] = __( 'Full Width', 'productive-demo-importer' );
        }
    ...
    function productive_global_get_popup_screen_positions() {
        return array (
            PRODUCTIVE_GLOBAL_POPUP_SCREEN_POSITION_TOP_RIGHT           => __( 'Top Right', 'productive-demo-importer' ),
            PRODUCTIVE_GLOBAL_POPUP_SCREEN_POSITION_TOP_LEFT            => __( 'Top Left', 'productive-demo-importer' ),
            PRODUCTIVE_GLOBAL_POPUP_SCREEN_POSITION_BOTTOM_RIGHT        => __( 'Bottom Right', 'productive-demo-importer' ),
            PRODUCTIVE_GLOBAL_POPUP_SCREEN_POSITION_BOTTOM_LEFT         => __( 'Bottom Left', 'productive-demo-importer' ),
            PRODUCTIVE_GLOBAL_POPUP_SCREEN_POSITION_CENTRAL             => __( 'Central', 'productive-demo-importer' ),
            PRODUCTIVE_GLOBAL_POPUP_SCREEN_POSITION_LEFT             => __( 'Left', 'productive-demo-importer' ),
            PRODUCTIVE_GLOBAL_POPUP_SCREEN_POSITION_RIGHT             => __( 'Right', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_popup_transition_easings() {
        return array (
            '--ease' => __( 'Ease', 'productive-demo-importer' ),
            '--ease-in' => __( 'Ease In', 'productive-demo-importer' ),
            '--ease-out' => __( 'Ease Out', 'productive-demo-importer' ),
            '--ease-in-out' => __( 'Ease In/Out', 'productive-demo-importer' ),
            '--linear' => __( 'Linear', 'productive-demo-importer' ),
            '--cubic-bezier-1' => __( 'Cubic Bezier Style 1', 'productive-demo-importer' ),
            '--cubic-bezier-2' => __( 'Cubic Bezier Style 2', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_popup_transition_directions() {
        return array (
            'slideFromTop' => __( 'Top', 'productive-demo-importer' ),
            'slideFromBottom' => __( 'Bottom', 'productive-demo-importer' ),
            'slideFromLeft' => __( 'Left', 'productive-demo-importer' ),
            'slideFromRight' => __( 'Right', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_popup_transition_directions_customizers() {
        return array (
            'top' => __( 'Top', 'productive-demo-importer' ),
            'bottom' => __( 'Bottom', 'productive-demo-importer' ),
            'left' => __( 'Left', 'productive-demo-importer' ),
            'right' => __( 'Right', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_blog_archives_style_options() {
        return array(
            'blog_archive_design_default' => __( 'Default Design', 'productive-demo-importer' ),
            'blog_archive_design_01' => __( 'Design 01', 'productive-demo-importer' ),
            'blog_archive_design_02' => __( 'Design 02', 'productive-demo-importer' ),
            'blog_archive_design_03' => __( 'Design 03', 'productive-demo-importer' ),
            'blog_archive_design_04' => __( 'Design 04', 'productive-demo-importer' ),
            'blog_archive_design_05' => __( 'Design 05', 'productive-demo-importer' ),
            'blog_archive_design_06' => __( 'Design 06', 'productive-demo-importer' ),
            'blog_archive_design_07' => __( 'Design 07', 'productive-demo-importer' ),
            'blog_archive_design_08' => __( 'Design 08', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_woo_archives_style_options() {
        return array(
            'product_archive_design_01' => __( 'Design 01', 'productive-demo-importer' ),
            'product_archive_design_02' => __( 'Design 02', 'productive-demo-importer' ),
            'product_archive_design_03' => __( 'Design 03', 'productive-demo-importer' ),
            'product_archive_design_04' => __( 'Design 04', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_popup_cols_per_row_values() {
        return array (
            1 => __( '1 - Default', 'productive-demo-importer' ),
            2 => __( '2', 'productive-demo-importer' ),
            3 => __( '3', 'productive-demo-importer' ),
            4 => __( '4', 'productive-demo-importer' ),
            5 => __( '5', 'productive-demo-importer' ),
            6 => __( '6', 'productive-demo-importer' ),
            7 => __( '7', 'productive-demo-importer' ),
            8 => __( '8', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_slider_transition_styles() {
        return array (
            'slide' => __( 'Slide', 'productive-demo-importer' ),
            'fade' => __( 'Fade', 'productive-demo-importer' ),
            'flip' => __( 'Flip', 'productive-demo-importer' ),
            'cards' => __( 'Cards', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_slider_transition_delays() {
        return array (
            '1000' => __( '1 second', 'productive-demo-importer' ),
            '2000' => __( '2 seconds', 'productive-demo-importer' ),
            '3000' => __( '3 seconds', 'productive-demo-importer' ),
            '4000' => __( '4 seconds', 'productive-demo-importer' ),
            '5000' => __( '5 seconds', 'productive-demo-importer' ),
            '7500' => __( '7.5 seconds', 'productive-demo-importer' ),
            '10000' => __( '10 seconds', 'productive-demo-importer' ),
            '15000' => __( '15 seconds', 'productive-demo-importer' ),
            '20000' => __( '20 seconds', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_slider_transition_directions() {
        return array (
            'horizontal' => __( 'Horizontal', 'productive-demo-importer' ),
            //'vertical' => __( 'Vertical', 'productive-demo-importer' ),
        );
    }
    ...
    function productive_global_get_slider_user_controls() {
        return array (
            'none'                      => __( 'None', 'productive-demo-importer' ),
            'touch_swipe'               => __( 'Touch Swipe Only', 'productive-demo-importer' ),
            'dots'                      => __( 'Pagination Dots Only', 'productive-demo-importer' ),
            'arrows'                    => __( 'Prev/Next Arrows Only', 'productive-demo-importer' ),
            'dots_and_arrows'           => __( 'Dots &#38; Arrows', 'productive-demo-importer' ),
            'touch_swipe_and_arrows'    => __( 'Touch Swipe &#38; Arrows', 'productive-demo-importer' ),
            'touch_swipe_and_dots'      => __( 'Touch Swipe &#38; Dots', 'productive-demo-importer' ),
            'all'                       => __( 'Allow All Three Actions', 'productive-demo-importer' ),
        );
    }
    ...
    function productive_global_get_slides_per_view_values() {
        return array (
            '1' => __( '1 - Default', 'productive-demo-importer' ),
            '1.5' => __( '1.5', 'productive-demo-importer' ),
            '2' => __( '2', 'productive-demo-importer' ),
            '2.5' => __( '2.5', 'productive-demo-importer' ),
            '3' => __( '3', 'productive-demo-importer' ),
            '3.5' => __( '3.5', 'productive-demo-importer' ),
            '4' => __( '4', 'productive-demo-importer' ),
            '4.5' => __( '4.5', 'productive-demo-importer' ),
            '5' => __( '5', 'productive-demo-importer' ),
            '5.5' => __( '5.5', 'productive-demo-importer' ),
            '6' => __( '6', 'productive-demo-importer' ),
            '6.5' => __( '6.5', 'productive-demo-importer' ),
            '7' => __( '7', 'productive-demo-importer' ),
            '7.5' => __( '7.5', 'productive-demo-importer' ),
            '8' => __( '8', 'productive-demo-importer' ),
        );
    }
    ...
    function productive_global_get_popup_when_modal_goes_fullscreens() {
        return array (
            'disabled'          => __( 'Disable', 'productive-demo-importer' ),
            'mobile_portrait'   => __( 'Mobile (portrait)', 'productive-demo-importer' ),
            'mobile_landscpe'   => __( 'Mobile (Landscape)', 'productive-demo-importer' ),
            'tablet_portrait'   => __( 'Tablet (portrait)', 'productive-demo-importer' ),
            'tablet_landscpe'   => __( 'Tablet (Landscape)', 'productive-demo-importer' ),
            'desktop'           => __( 'Desktop', 'productive-demo-importer' ),
            'widescreen'        => __( 'Widescreen', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_popup_bg_opacity_options() {
        return array (
            '0.1' => __( '0.1 (transparent)', 'productive-demo-importer' ),
            '0.2' => __( '0.2', 'productive-demo-importer' ),
            '0.3' => __( '0.3', 'productive-demo-importer' ),
            '0.4' => __( '0.4', 'productive-demo-importer' ),
            '0.5' => __( '0.5', 'productive-demo-importer' ),
            '0.6' => __( '0.6', 'productive-demo-importer' ),
            '0.7' => __( '0.7', 'productive-demo-importer' ),
            '0.8' => __( '0.8', 'productive-demo-importer' ),
            '0.9' => __( '0.9', 'productive-demo-importer' ),
            '1.0' => __( '1.0 (opaque)', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_heading_tag_css_classes() {
        return array (
            'h1' => __( 'h1 css style', 'productive-demo-importer' ),
            'h2' => __( 'h2 css style', 'productive-demo-importer' ),
            'h3' => __( 'h3 css style', 'productive-demo-importer' ),
            'h4' => __( 'h4 css style', 'productive-demo-importer' ),
            'h5' => __( 'h5 css style', 'productive-demo-importer' ),
            'h6' => __( 'h6 css style', 'productive-demo-importer' ),
        );
    }

    function productive_global_get_content_html_tags() {
        return array (
            'h1' => __( 'h1 html tag', 'productive-demo-importer' ),
            'h2' => __( 'h2 html tag', 'productive-demo-importer' ),
            'h3' => __( 'h3 html tag', 'productive-demo-importer' ),
            'h4' => __( 'h4 html tag', 'productive-demo-importer' ),
            'h5' => __( 'h5 html tag', 'productive-demo-importer' ),
            'h6' => __( 'h6 html tag', 'productive-demo-importer' ),
            'div' => __( 'div html tag', 'productive-demo-importer' ),
            'span' => __( 'span html tag', 'productive-demo-importer' ),
        );
    }
    ...
    function productive_global_get_cpt_terms($taxonomy, $include_all_option_first = true, $oder_by = 'name', $order = 'ASC', $by_slug = 0 ) {
        ...
        if( $include_all_option_first ) {
            $element_terms[''] = __('All', 'productive-demo-importer');
        }
    ...
    function productive_global_get_select_options_for_cpt_query_order_by( $cpt_extra = 0 ) {
        $order_terms = array(
            'newest' => __( 'Newest First', 'productive-demo-importer' ),
            'oldest' => __( 'Oldest First', 'productive-demo-importer' ),
            'menu_order' => __( 'My Order', 'productive-demo-importer' ),
            'title_a_z' => __( 'Title (a-z)', 'productive-demo-importer' ),
            'title_z_a' => __( 'Title (z-a)', 'productive-demo-importer' ),
        );
        return $order_terms;
    }
    ...
    function productive_global_get_button_radius_shapes() {
        return array (
            'sharp_corners' => __( 'Sharp Corners', 'productive-demo-importer' ),
            'round_corners' => __( 'Round Corners', 'productive-demo-importer' ),
            'ellipse' => __( 'Ellipse', 'productive-demo-importer' ),
        );
    }
    
    function productive_global_get_slider_pagination_control_shapes($show_none = 0) {
        $control_shapes = array (
            'slider_pagination_shape_circle'        => __( 'Circle', 'productive-demo-importer' ),
            'slider_pagination_shape_square'        => __( 'Square', 'productive-demo-importer' ),
            'slider_pagination_shape_rectangle'     => __( 'Rectangle', 'productive-demo-importer' ),
            'slider_pagination_shape_hybrid'        => __( 'Hybrid', 'productive-demo-importer' ),
        );
        if( $show_none ) {
            $control_shapes['none-pagination'] = __( 'None (hide pagination controls)', 'productive-demo-importer' );
        }
    ...
    function productive_global_get_slider_nav_control_shapes($show_none = 0) {
        $control_shapes = array (
            'slider_nav_shape_circle' => __( 'Circle', 'productive-demo-importer' ),
            'slider_nav_shape_square' => __( 'Square', 'productive-demo-importer' ),
            'slider_nav_shape_none' => __( 'Transparent background', 'productive-demo-importer' ),
        );
        if( $show_none ) {
            $control_shapes['none-arrow'] = __( 'None (hide nav controls)', 'productive-demo-importer' );
        }
        return $control_shapes;
    }
    ...
    ?>
        <span class="close-productive-display-button-icon">
            ...
            <span class="screen-reader-text"><?php echo esc_html('Close Overlay', 'productive-demo-importer'); ?></span>
        </span>
    <?php } else { ?>
        <span class="close-productive-display-button-icon">
    ...
    ?>
        <span class="close-productive-display-button-icon on_the_spot">
            ...
            <span class="screen-reader-text"><?php echo esc_html('Close', 'productive-demo-importer'); ?></span>
        </span>
    <?php } else { ?>
        <span class="close-productive-display-button-icon on_the_spot">
            <span class="the_close_icon <?php echo esc_attr($transparent_bg); ?>">
    ...
    function productive_global_get_close_element_button_relative( $icon_size = 16, $use_icon = false, $icon_color_css = 'productive_global_icon_general_color', $font_size = 10, $font_css = 'red ', $transparent_bg = '' ) {
        ...
        if( !$use_icon ) {
            ...
            $close_element_button .= '<span class="screen-reader-text">' . __('Close', 'productive-demo-importer') . '</span>';
                ...
                <div class="">
                    <?php if ($prev) {
                        ...
                        <a class="prev-next-post-link-anchor productiveminds-alignable-container align-items-center align-content-center justify-items-start justify-content-flex-start row-gap-5px" 
                           aria-label="<?php echo esc_attr('Previous', 'productive-demo-importer'); ?>" href="<?php echo esc_url(get_permalink($prev->ID)); ?>">
                            ...
                            <span class="screen-reader-text"><?php echo esc_html('Previous', 'productive-demo-importer'); ?></span>
                        </a>
                    <?php } ?>
                </div>
                <div class="">
                    <?php if ($next) {
                        ...
                        <a class="prev-next-post-link-anchor productiveminds-alignable-container align-items-center align-content-center justify-items-end justify-content-flex-end row-gap-5px" 
                           aria-label="<?php echo esc_attr('Next', 'productive-demo-importer'); ?>" href="<?php echo esc_url(get_permalink($next->ID)); ?>">
    ...
    function productive_global_the_posts_navigation() {
        the_posts_pagination(
            array(
                ...
                'screen_reader_text' => __( 'Page Content Navigation ', 'productive-demo-importer' ),
    ...
    function productive_global_paginate_links( $productive_cpt = array(), $prev_icon = '<', $next_icon = '>', $prev_text = '', $next_text = '', $show_all = false ) {
        ...
        $prev_text_copy = __( 'Previous', 'productive-demo-importer' );
        if( '' != $prev_text ) {
            $prev_text_copy = $prev_text;
        }
        
        $next_text_copy = __( 'Next', 'productive-demo-importer' );
        if( '' != $next_text ) {
        ...
        <div class="productiveminds_section-query-pagination-nav productiveminds_archive_pagination_nav">
            <div class="nav-links">
                ...
                echo paginate_links( array(
                    ...
                    'total' => $total,
                    'before_page_number' => '<span class="screen-reader-text">' . __( 'Page ', 'productive-demo-importer' ) . ' </span>',
