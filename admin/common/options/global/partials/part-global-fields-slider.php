...
?>
    <p>
        <h2><?php echo esc_html__( 'Global Slider Settings', 'productive-demo-importer' ) ?></h2>
        <div><?php echo esc_html__( 'These setting are relevant to all sliders that are generated by our plugins and themes.', 'productive-demo-importer' ) ?></div>
    </p>
<?php
}
...
function productive_global_add_section_slider_fields($productive_global_section_slider_options) {
    ...
    add_settings_field(
        ...
        __( 'Slides Transition style', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Play slides automatically?', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Play slides in Loop?', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Pause on MouseOver?', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Enable Lazy Loading?', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Delays between slides transition', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Transition Direction', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Slides Transition Controls', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Slider Controls Primary Colour', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Slider Controls Secondary Colour', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Slider Bottom Pagination Controls Shape', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Slider Side Navigation Controls Shape', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Slider Nav Controls Padding', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Widescreen', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Desktop', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Tablet (landscape)', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Tablet (portrait)', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Mobile (landscape)', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Mobile (portrait)', 'productive-demo-importer' ), // Field label
...
function productive_global_callback_slider_transition_style( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'The style of slide transition', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_autoplay_enable() {
    ...
    <p>
        ...
        <label for="productive_global_section_slider_options[is_on_productive_global_slider_autoplay_enable]"><?php echo esc_html__( 'Automatically play slides.', 'productive-demo-importer' ); ?></label>
    </p>
   <?php
}
...
function productive_global_callback_slider_play_loop_enable() {
    ...
    <p>
        ...
        <label for="productive_global_section_slider_options[is_on_productive_global_slider_play_loop_enable]"><?php echo esc_html__( 'Play slides in infinite loop', 'productive-demo-importer' ); ?></label>
    </p>
   <?php
}
...
function productive_global_callback_slider_pause_on_mouse_over_enable() {
    ...
    <p>
        ...
        <label for="productive_global_section_slider_options[is_on_productive_global_slider_pause_on_mouse_over_enable]"><?php echo esc_html__( 'Pause slide autoplay when user hovers on slide', 'productive-demo-importer' ); ?></label>
    </p>
   <?php
}
...
function productive_global_callback_slider_lazy_loading_enable() {
    ...
    <p>
        ...
        <label for="productive_global_section_slider_options[is_on_productive_global_slider_lazy_loading_enable]"><?php echo esc_html__( 'Enable lazy loading', 'productive-demo-importer' ); ?></label>
    </p>
   <?php
}
...
function productive_global_callback_slider_transition_delay( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'The delay between slide transitions.', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_transition_direction( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Transitions direction - only horizontal supported.', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_user_controls( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Which slides transition control(s) are users allowed?', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_buttons_color_primary( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Effective on both side navigation and bottom pagination buttons.', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_slider_pagination_control_shape( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Pagination controls buttons shape (bottom dots)s.', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_nav_control_shape( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slider navigation control buttons shape (left and right side buttons).', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_slides_per_view_heading( $args ) {
    ?>
    <h3><?php echo esc_html__( 'Slides Per View Settings', 'productive-demo-importer' ) ?></h3>
   <?php
}
...
function productive_global_callback_slider_slides_per_view_widescreen( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slides Per View on Widescreen', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_slides_per_view_desktop( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slides Per View on Desktop', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_slides_per_view_tablet_landscape( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slides Per View on Tablet (Landscape)', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_slides_per_view_tablet_portrait( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slides Per View on Tablet (Portrait)', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_slides_per_view_mobile_landscape( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slides Per View on Mobile (Landscape)', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_slides_per_view_mobile_portrait( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slides Per View on Mobile (Portrait)', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
