...
?>
    <p>
        <h2><?php echo esc_html__( 'Global PopUp Settings', 'productive-demo-importer' ) ?></h2>
        <div><?php echo esc_html__( 'These setting are relevant to all PopUps that are generated by our plugins and themes', 'productive-demo-importer' ) ?></div>
    </p>
<?php
}
...
function productive_global_add_section_popup_fields($productive_global_section_popup_options) {
    ...
    add_settings_field(
        ...
        __( 'Popup Transition Easing Mode', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Popup Transition IN/OUT Direction', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Popup Header and Footer Background Colour', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Popup Header and Footer Text Colour', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Popup Header and Footer Hyperlinks Colour', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Popup Header and Footer Hyperlinks Colour (on hover)', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Popup Close Button Colour', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Popup Close Button Background', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Popup Close Button Colour (on Hover)', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Popup Close Button Background (on Hover)', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Popup Minimum width (px)', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Popup Max width (px)', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Popup Full Screen Mode (px)', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Close Popup with ESC Key?', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Click Elsewhere to Close Popup?', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Popup Background Opacity', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Use Styles from the Theme?', 'productive-demo-importer' ), // Field label
...
function productive_global_callback_popup_transition_easing( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'The easing mode for entrance and exit of Popup.', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_popup_transition_direction( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'The direction of transition for entrance and exit of Popup', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_popup_footer_bg_color( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Background colour for popup header and footer background.', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_popup_header_footer_text_color( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Colour of textual content in popup header and footer', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_popup_header_footer_hyperlink_color( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Colour of hyperlink(s) in popup header and footer', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_popup_header_footer_hyperlink_color_hover( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Colour of hyperlink(s) in popup header and footer on hover', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_popup_close_button_color( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Close button colour', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_popup_close_button_color_bg( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Close button background colour', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_popup_close_button_color_hover( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Close button colour (on Hover)', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_popup_close_button_color_hover_bg( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Close button background colour (on Hover)', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_popup_when_modal_goes_fullscreen( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Popuup will fill the screen both vertically and horizontally, at this screen size - set to 0 to disable this feature.', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_popup_close_with_esc_key_enable() {
    ...
    <p>
        ...
        <label for="productive_global_section_popup_options[is_on_productive_global_popup_close_with_esc_key_enable]"><?php echo esc_html__( 'Allow users to close popup by pressing escape key on their keyboard?', 'productive-demo-importer' ); ?></label>
    </p>
   <?php
}
...
function productive_global_callback_popup_close_with_click_elsewhere_enable() {
    ...
    <p>
        ...
        <label for="productive_global_section_popup_options[is_on_productive_global_popup_close_with_click_elsewhere_enable]"><?php echo esc_html__( 'Allow users to close popup by clicking outside the popup modal?', 'productive-demo-importer' ); ?></label>
    </p>
   <?php
}
...
function productive_global_callback_popup_bg_opacity( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Popup background transparency (opacity)', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_popup_use_theme_style() {
    ...
    <p>
        ...
        <label for="productive_global_section_popup_options[is_on_productive_global_popup_use_theme_style]"><?php echo esc_html__( 'Ignore settings on this page and use theme css styles instead. Effective only when using one of our themes. ', 'productive-demo-importer' ); ?></label>
    </p>
   <?php
}
