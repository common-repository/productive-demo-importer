...
?>
    <p>
        <h2><?php echo esc_html__( 'Social Media Sharing Settings', 'productive-demo-importer' ) ?></h2>
        <div><?php echo esc_html__( 'These social media sharing options are efective across all our plugins and themes', 'productive-demo-importer' ) ?></div>
    </p>
<?php
}
...
function productive_global_add_section_sharing_fields($productive_global_section_sharing_options) {
    ...
    add_settings_field(
        ...
        __( 'Icons Colour', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Icons Background Colour', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Icons Background Colour (on Hover)', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Use Platform Background and White Icon ', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Location of the "Share On:" Copy', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Icons Size (px)', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Icons Spacing (px)', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Enable Facebook Sharing?', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Enable X (Twitter) Sharing?', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Enable PInterest Sharing?', 'productive-demo-importer' ), // Field label
...
/*
    ...
    add_settings_field(
        ...
        __( 'Enable Instagram Sharing?', 'productive-demo-importer' ), // Field label
...
*/
    ...
    add_settings_field(
        ...
        __( 'Enable WhatsApp Sharing?', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Enable Email Sharing?', 'productive-demo-importer' ), // Field label
...
function productive_global_callback_sharing_heading( $args ) {
    ?>
    <h3><?php echo esc_html__( 'Icon Colours and Dimensions', 'productive-demo-importer' ) ?></h3>
   <?php
}
...
function productive_global_callback_sharing_icon_color( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'The main colour of each icon. Leave empty to use each social media icon original colour', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_sharing_icon_bg_color( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Colour of the background surrounding each icon', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_sharing_icon_bg_color_hover( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Colour of the background surrounding each icon when hovering over it', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
    ...
    ?>
        <select id="<?php echo esc_attr( $args['label_for'] ); ?>" class="<?php echo esc_attr( $args['class'] ); ?>"
            ...
            <option value="brand_color_around_white_icon" <?php echo selected( $productive_global_sharing_brand_color_around_white_icon, 'brand_color_around_white_icon', false ); ?>>
               <?php echo esc_html__( 'Yes', 'productive-demo-importer' ); ?>
            </option>
            <option value="no_brand_bg_with_icon" <?php echo selected( $productive_global_sharing_brand_color_around_white_icon, 'no_brand_bg_with_icon', false ); ?>>
                <?php echo esc_html__( 'No', 'productive-demo-importer' ); ?>
            </option>
        </select>
        <p>
            <?php echo esc_html__( 'Highlight social media icons using brand logo colors around a white icon.', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
    ...
    ?>
        <select id="<?php echo esc_attr( $args['label_for'] ); ?>" class="<?php echo esc_attr( $args['class'] ); ?>"
            ...
            <option value="top" <?php echo selected( $productive_global_sharing_share_on_copy_location, 'top', false ); ?>>
               <?php echo esc_html__( 'Above Icons', 'productive-demo-importer' ); ?>
            </option>
            <option value="inline" <?php echo selected( $productive_global_sharing_share_on_copy_location, 'inline', false ); ?>>
                <?php echo esc_html__( 'Inline with Icons', 'productive-demo-importer' ); ?>
            </option>
        </select>
        <p>
            <?php echo esc_html__( 'Place the "Share on:" copy above or inline with social media icons', 'productive-demo-importer' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_sharing_icon_size( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'The size of each icon (default is: 20).', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_sharing_icon_spacing( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'The spacing between the icons (default is: 2).', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_sharing_enabled_heading( $args ) {
    ?>
    <h3><?php echo esc_html__( 'Social Media Platforms Availability', 'productive-demo-importer' ) ?></h3>
   <?php
}
