...
?>
    <p>
        <h2><?php echo esc_html__( 'Other Global Settings', 'productive-demo-importer' ) ?></h2>
        <div><?php echo esc_html__( 'These setting are relevant across all our plugins and themes', 'productive-demo-importer' ) ?></div>
    </p>
<?php
}
...
function productive_global_add_section_misc_fields($productive_global_section_misc_options) {
    ...
    add_settings_field(
        ...
        __( 'Loading Animation Colour 1', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Loading Animation Colour 2', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Loading Animation Wheel Diameter (px)', 'productive-demo-importer' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Loading Animation Wheel Thickness (px)', 'productive-demo-importer' ), // Field label
...
function productive_global_callback_misc_heading_loading_wheel( $args ) {
    ?>
    <h3><?php echo esc_html__( 'Loading Animation Wheel Settings', 'productive-demo-importer' ) ?></h3>
   <?php
}
...
function productive_global_callback_misc_is_loading_color_1( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'First color of the loading animation wheel.', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_misc_is_loading_color_2( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Second color of the loading animation wheel', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_misc_is_loading_size( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'The size of the loading animation wheel (default is: 25).', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_misc_is_loading_thickness( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'The thickness of the loading animation wheel (default is: 7).', 'productive-demo-importer' ); ?>
    </p>
   <?php
}
